...
# $Date: 2020-10-23 07:53:06 -0700 (Fri, 23 Oct 2020) $
# $Author: vondreele $
# $Revision: 4619 $
# $URL: https://subversion.xray.aps.anl.gov/pyGSAS/trunk/GSASIIIO.py $
# $Id: GSASIIIO.py 4619 2020-10-23 14:53:06Z vondreele $
########### SVN repository information ###################
'''
...
import GSASIIpath
GSASIIpath.SetVersionNumber("$Revision: 4619 $")
try:
...
objectScanIgnore = [int,bool,float,str,np.float64,np.float32,np.int32,np.int64,np.ndarray,G2obj.G2VarObj,G2obj.ExpressionObj]
try:
