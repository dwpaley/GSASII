...
# $Date: 2020-10-13 07:05:15 -0700 (Tue, 13 Oct 2020) $
# $Author: vondreele $
# $Revision: 4592 $
# $URL: https://subversion.xray.aps.anl.gov/pyGSAS/trunk/GSASIIpwd.py $
# $Id: GSASIIpwd.py 4592 2020-10-13 14:05:15Z vondreele $
########### SVN repository information ###################
...
import GSASIIpath
filversion = "$Revision: 4592 $"
GSASIIpath.SetVersionNumber("$Revision: 4592 $")
